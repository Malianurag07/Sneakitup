...
# The absolute path to the directory where Django will store uploaded files
# We are telling it to create a 'media' folder in our 'backend' (BASE_DIR)
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')

# The URL that browsers will use to access these files
MEDIA_URL = '/media/'


# --- CORS Settings ---
# This tells our backend to accept requests from our frontend
# (which will run on http://localhost:3000)

CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "http://127.0.0.1:3000",
]
# A unique key to store the cart in the user's session
